...
public class UserEndpoint {
    ...
    @ApiMethod(
            name = "insert")
    public void insert(@Named("id") String id, @Named("name") String name, @Named("surname") String surname,@Named("email") String email) {
        ...
        User user=new User (Long.valueOf(id),name,surname,email);
