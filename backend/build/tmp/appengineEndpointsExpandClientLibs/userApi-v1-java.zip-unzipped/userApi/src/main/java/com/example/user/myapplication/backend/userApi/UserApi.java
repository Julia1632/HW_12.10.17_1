 ...
 * on 2017-10-20 at 20:54:39 UTC 
 * Modify at your own risk.
 */

package com.example.user.myapplication.backend.userApi;
...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Get extends UserApiRequest<com.example.user.myapplication.backend.userApi.model.User> {
    ...
    protected Get(java.lang.Long mId) {
      super(UserApi.this, "GET", REST_PATH, null, com.example.user.myapplication.backend.userApi.model.User.class);
   ...
   * @return the request
   */
  public Insert insert(java.lang.String id, java.lang.String name, java.lang.String surname, java.lang.String email) throws java.io.IOException {
    Insert result = new Insert(id, name, surname, email);
    initialize(result);
    return result;
  }

  public class Insert extends UserApiRequest<Void> {

    private static final String REST_PATH = "user/{id}/{name}/{surname}/{email}";
     ...
     * @since 1.13
     */
    protected Insert(java.lang.String id, java.lang.String name, java.lang.String surname, java.lang.String email) {
    ...
    public Insert setSurname(java.lang.String surname) {
  ...
  public class List extends UserApiRequest<com.example.user.myapplication.backend.userApi.model.CollectionResponseUser> {
     ...
     */
    protected List() {
      super(UserApi.this, "GET", REST_PATH, null, com.example.user.myapplication.backend.userApi.model.CollectionResponseUser.class);
    }
   ...
   *
   * @param mId
   * @param content the {@link com.example.user.myapplication.backend.userApi.model.User}
   * @return the request
   */
  public Patch patch(java.lang.Long mId, com.example.user.myapplication.backend.userApi.model.User content) throws java.io.IOException {
    Patch result = new Patch(mId, content);
    initialize(result);
    return result;
  }

  public class Patch extends UserApiRequest<com.example.user.myapplication.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.Long mId, com.example.user.myapplication.backend.userApi.model.User content) {
      super(UserApi.this, "PATCH", REST_PATH, content, com.example.user.myapplication.backend.userApi.model.User.class);
      this.mId = com.google.api.client.util.Preconditions.checkNotNull(mId, "Required parameter mId must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(java.lang.Long mId, com.example.user.myapplication.backend.userApi.model.User content) throws java.io.IOException {
    Update result = new Update(mId, content);
    initialize(result);
    return result;
  }

  public class Update extends UserApiRequest<com.example.user.myapplication.backend.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.Long mId, com.example.user.myapplication.backend.userApi.model.User content) {
      super(UserApi.this, "PUT", REST_PATH, content, com.example.user.myapplication.backend.userApi.model.User.class);
      this.mId = com.google.api.client.util.Preconditions.checkNotNull(mId, "Required parameter mId must be specified.");
    }
